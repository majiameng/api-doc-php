<?php
namespace tinymeng\apidoc;

use tinymeng\apidoc\lib\Tools;

/**
 * Class BootstrapAPI文档生成
 * @package tinymeng\apidoc
        ...
        <div class="container-fluid">
             ...
             <div class="row">
                    <div class="col-lg-12 text-center copyright-content">
                        Copyright  2016 - 2018 <a href="http://www.majiameng.com">Tinymeng</a> 版权所有
                    </div>
                </div>
        </div>
        {$this->customJs}
